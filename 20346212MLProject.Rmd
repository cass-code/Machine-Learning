...
![Ridge]("images/ridge.png") \label{ridge}

</center>

<center>

![Lasso]("images/lasso.png") \label{lasso}
...
![RMSE comparison]("images/RMSE.png") \label{RMSEimg}
...
<!-- ```{r, warning =  FALSE, fig.align = 'center', fig.cap = "Confusion Matrix SVM \\label{confmat}", fig.height = 3, fig.width = 6, dev = 'png'} -->
<!-- library(png) -->
<!-- library(grid) -->
<!-- img <- readPNG("images/cmsvm.png") -->
<!-- grid.raster(img)  -->
<!-- ``` -->

<center>

![SVM Statistics]("images/statssvm.png")
...
# g2 <- draw_confusion_stats(predicted[[4]]) # tabulating the statistics
```
