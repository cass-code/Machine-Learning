...
mortality, expenditure, income and employment.
...
tibble {[}3 x 1{]} (S3: tbl\_df/tbl/data.frame) \$ Reg: num {[}1:3{]}
0.915 0.881 0.822 {[}1{]} ``RMSE on training set: 0.752131288720079''
{[}1{]} ``RMSE on test set: 0.882932895421073'' {[}1{]} ``RMSE on
training set: 0.752842149603987'' {[}1{]} ``RMSE on test set:
0.88481632436016'' {[}1{]} ``RMSE on training set: 0.752681521998011''
{[}1{]} ``RMSE on test set: 0.885305140817852'' {[}1{]} ``RMSE on
training set: 0.760957159147364'' {[}1{]} ``RMSE on test set:
0.734724499416784'' {[}1{]} ``RMSE on training set: 0.761176361760862''
{[}1{]} ``RMSE on test set: 0.735047813129022'' {[}1{]} ``RMSE on
training set: 0.76097313627485'' {[}1{]} ``RMSE on test set:
0.734938202183037''
...
\begin{figure}
\centering
\includegraphics{"images/statssvm.png"}
\caption{SVM Statistics}
\end{figure}

\begin{figure}[H]

{\centering \includegraphics{20346212MLProject_files/figure-latex/unnamed-chunk-8-1} 

}

\caption{Confusion Matrix \label{Figure3}}\label{fig:unnamed-chunk-8}
\end{figure}
